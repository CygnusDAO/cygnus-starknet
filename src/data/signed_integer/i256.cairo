/// TODO - Replace once starknet supports native i256
/// Taken from YAS: 
/// https://github.com/lambdaclass/yet-another-swap/tree/main/crates/yas_core/src/numbers/signed_integer

use integer::{BoundedInt, u256_wide_mul};
use cygnus::data::signed_integer::integer_trait::{IntegerTrait};
// ====================== INT 256 ======================
