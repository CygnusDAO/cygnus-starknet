...
mod X1Vault {
    ...
    impl X1Vault of IX1Vault<ContractState> {
        ...
        /// * IPillarsOfCreation
        fn get_user_info(
            self: @ContractState, user: ContractAddress, reward_token: ContractAddress
        ) -> UserInfo {
        ...
        fn deposit(ref self: ContractState, cyg_amount: u256) {
            ...
            loop {
                ...
                if previous_shares != 0 {
                    ...
                    let pending = previous_shares.full_mul_div(reward_per_share, ACC_PRECISION)
                        - previous_reward_debt;
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn update_reward_internal(
            ref self: ContractState, total_cyg: u256, reward_token: ContractAddress
        ) {
